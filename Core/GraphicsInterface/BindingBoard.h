...
public:
	virtual void BindingResource(size_t slotIdx, const GPUResource* ptr, ShaderParameterType type, ShaderParameterFlag flag1 = SHADER_PARAMETER_FLAG_NONE, int flag2 = 0) {}
	...
	bool IsEnableBinding() const { return m_enableBinding; }
protected:
