...
ProgramDescriptor DX12RenderBackend::RequestProgram(ShaderNames shader, ProgramOptions opts,
	VertexAttributeDescs vtxAttDesc, bool usedIndex) {
	/** TODO: 需要创建shader，然后分析它们的输入输出 */

	return ProgramDescriptor();
}

void DX12RenderBackend::analyseShader(const char * shaderName, ShaderType type)
{
	auto iterator = m_shaders.find(shaderName);
